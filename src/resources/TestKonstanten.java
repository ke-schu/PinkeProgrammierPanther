...
public interface TestKonstanten
{
    ...
    String VORSTELLEN_EINHEIT =
            " Hallo, ich bin eine beschworene Einheit und heiße ";
    String VORSTELLEN_GEGNER = " Hallo, ich bin der Gegner ";
    String POSITIONS_ANGABE_NULL_EINS = " ich stehe an Position 0,1 ";
    String POSITIONS_ANGABE_EINS_EINS =
            " nach dem Bewegen bin ich stehe an Position 1,1 ";
    String POSITIONS_ANGABE_EINHEIT = " und ich denke ich stehe in Spalte ";
    String POSITIONS_ANGABE_NULL_EINS_ENDE =
            " an Stelle 0, 1 befindet sich nun ";
    String POSITIONS_ANGABE_KAMPF =
            " an Stelle 0, 1 befindet sich vor dem Kampf ";
