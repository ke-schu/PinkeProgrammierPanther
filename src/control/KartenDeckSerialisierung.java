...
/**
 Diese Klasse ist ein benutzerdefinierter JsonSerializer und JsonDeserializer
 fuer ein KartenDeck. Es wird hier festgelegt, wie genau ein Kartendeck im
 Controller serialisiert bzw. deserialisiert wird, indem diese Klasse als
 Adapter im GsonBuilder eingebaut wird. */
public class KartenDeckSerialisierung
        implements JsonSerializer<KartenDeck>, JsonDeserializer<KartenDeck>
{
                                            ...
                                            JsonSerializationContext context)
    {
        ...
        jsonKartenDeck.addProperty(KARTEN_DECK_BEZEICHNUNG,
                                   src.getDeckBezeichnung());
            ...
            throws JsonParseException
    {
        ...
        JsonArray meinJsonArray =
                meinJsonObject.get(KARTEN_DECK_STACK).getAsJsonArray();
        
        KartenDeck meinKartenDeck = new KartenDeck(
                meinJsonObject.get(KARTEN_DECK_BEZEICHNUNG).getAsString());
