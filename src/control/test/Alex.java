...
public class Alex
{
    public static void ausfuehren()
    {
        ...
        try
        {
            ...
            System.out.println("Hallo ich bin der Spieler " + spieler.getName());
            ...
            System.out.println("Hallo ich bin eine beschworene Einheit und heiße " + meinfeld.getSpielfeldplatz(1, 0).getName() + " ich stehe an position 0,1 ");
            System.out.println("und ich denke ich stehe in Spalte " + meinfeld.getSpielfeldplatz(1, 0).getPosition_x());
            System.out.println("und Zeile " + meinfeld.getSpielfeldplatz(1, 0).getPosition_y() + ZEILENUMBRUCH);

            //Gegner gibt Ihre Position wieder und bewegt sich danach um anschließend wieder ihre Position wiederzugeben
            System.out.println("Ich bin der Gegner " + meinfeld.getSpielfeldplatz(meinfeld.getFeldZeile() - ZAHL_1,
                    meinfeld.getFeldSpalte() - ZAHL_1) + " und vor dem bewegen stehe ich an position " + (meinfeld.getFeldZeile()) + "," + (meinfeld.getFeldSpalte()));
            System.out.println("jetzt bewege ich mich...");
            ...
            System.out.println("nach dem bewegen bin ich stehe an position 1,1 " + meinfeld.getSpielfeldplatz(1, 1) + ZEILENUMBRUCH);
            ...
            System.out.println("jetzt wird gerade gekaempft...");
            einheitenAngreifenMitEinheiten(meinfeld, master, meinfeld.getSpielfeldplatz(1, 0));
            System.out.println("Lebenspunkte freund einheit nach Kampf: " + meinfeld.getSpielfeldplatz(1, 0).getLebenspunkte() + ZEILENUMBRUCH);
