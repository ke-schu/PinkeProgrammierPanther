...
public class Ebene
{
    ...
    /**
     Konstruktor der Klasse Ebene, welcher einen 2D-Array erstellt der Raeume
     beinhaltet. Der Raumarray hat dabei die Abmasse der beiden uebergebenen
     Integer.
     @param ebenenZeile Abmessung der Zeilengroesse des Arrays.
     @param ebenenSpalte Abmessung der Spaltengroesse des Arrays.
     */
    public Ebene (SpielfigurEbene spielfigur, int ebenenZeile,
                  int ebenenSpalte)
    {
    ...
    /**
     ...
     und setzt.
     @param ebenenZeile Int-Wert der in das Attribut ebeneZeile gesetzt werden
     soll.
    ...
    /**
     Methode um an einer bestimmten Position den Inhalt des Attributes
     ebene zu
     bekommen.
     @param x Position der Spalte von dem der Inhalt zurueck gegeben wird.
     @param y Position der Zeile von dem der Inhalt zurueck gegeben wird.
