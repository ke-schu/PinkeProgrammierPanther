...
public class Charakter
{
    ...
    /**
     ...
     @throws JsonNichtLesbarException Exception, welche sich im Fall eines
     fehlerhaften Decks um eine Loesung kuemmert.
     */
    public Charakter (String name, int freischaltgebuehr, Spieler spieler,
                      boolean freigeschaltet) throws JsonNichtLesbarException
    {
        this.name = name;
        ...
        this.startDeck =
                kartenDeckIO.leseKartenDeck(
                        String.format(START_DECK_PFAD, name));
    }
