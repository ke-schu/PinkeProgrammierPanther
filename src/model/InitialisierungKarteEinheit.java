...
/**
 InitialisierungKarteEinheit ist verantwordlich fuer das Zwischenspeichern von
 Werten welche fuer das initialisieren von Kartenattributen gebraucht
 werden. */
public class InitialisierungKarteEinheit
{
    ...
    /**
     Methode um eine Instanz der Klasse Position aus dem Attribut position zu
     bekommen.
    ...
    /**
     ...
     setzen.
     @param position Instanz der Klasse Position die in das Attribut position
     gesetzt werden soll.
     */
