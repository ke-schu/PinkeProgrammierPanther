...
public class SpielStand
{
    ...
    /**
     ...
     @throws JsonNichtLesbarException wenn die Kartendecks des Spielers oder
     des Gegners Fehler enthalten.
     */
    public SpielStand (SpielStand stand) throws JsonNichtLesbarException
    {
        ...
        this.spieldeckGegner =
                kartenDeckIO.leseKartenDeck(SPIEL_DECK_GEGNER_PFAD);
    ...
    /**
     ...
     des Gegners Fehler enthalten.
     */
    public SpielStand (int gold, Spieler spieler, Gegenspieler gegenSpieler)
    ...
    /**
     Setter Methode um das Attribut aktuelleEbeneNummer zu setzen.
     @param aktuelleEbeneNummer auf welchen das Attribut gesetzt werden soll.
     */
