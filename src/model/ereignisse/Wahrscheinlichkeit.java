...
/**
 Dieses Interface enthaelt Konstanten und Methoden, welche fuer die Ermittlung
...
public interface Wahrscheinlichkeit
{
    ...
    double ACHTZIG_PROZENT = 80.0;
    double HUNDERT_PROZENT = 100.0;
    
    /**
     Diese Methode dient zum generieren einer Wahrscheinlichkeit. Die
     jeweilige
     Klasse formuliert die Methode selbst aus.
