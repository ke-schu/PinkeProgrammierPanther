...
public abstract class GuiController implements Initializable
{
    ...
    /**
     Methode, welche die Methode offneHilfeTextEinsetzen aufruft. Diese
     Methode
     wird durch
    ...
    /**
     ...
     @param hilfeText String welcher in dem Popup als Text eingesetzt werden
     soll.
     */
    ...
    /**
     ...
     werden.
     */
    @FXML public void wechselZuHauptmenue (ActionEvent event)
            throws IOException
    {
     ...
     */
    protected void wechselZu (ActionEvent event, String pfad)
            throws IOException
    {
    ...
    /**
     ...
     werden.
     */
    @FXML public void wechselZuSpielEbene (ActionEvent event)
            throws IOException
    {
    ...
    /**
     ...
     werden.
     */
    @FXML public void wechselZuSpielerFeld (ActionEvent event)
            throws IOException
    {
    ...
    /**
     ...
     werden.
     */
    @FXML public void wechselZuGegenspielerFeld (ActionEvent event)
            throws IOException
    {
